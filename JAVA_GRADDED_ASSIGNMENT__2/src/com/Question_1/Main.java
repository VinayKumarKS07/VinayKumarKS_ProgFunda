...
public class Main {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        serializeMap("C:\\Vinay\\JAVA_GRADDED_ASSIGNMENT\\Question_1\\ser.txt", map1);
        
       Map<Project, ArrayList<Employee>> deserializedMap1 = deserializeMap("C:\\Vinay\\JAVA_GRADDED_ASSIGNMENT\\Question_1\\ser.txt");
       System.out.println("Deserializtion begins");
